...
int main(int argc, char** argv)
{
  ...
  app.add_option("traces", trace_names, "The paths to the traces")->required()->expected(1)->check(CLI::ExistingFile);

  app.add_option("--logpoints", logpoints, "The points at which an entry is made to the log");

  app.add_option("--logfile", logfile, "The filename of the log");
