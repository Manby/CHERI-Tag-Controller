...
ChampSim is distributed under the Apache-2.0 licence. The licence allows free redistribution and modification of the software. My project requires modifications to be made to ChampSim, so, as per the licence, I state that such modifications are made in the README of the repository.\\
