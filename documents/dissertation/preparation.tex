...
ChampSim is an open-source trace based cache simulator written in C++. There is more information about ChampSim at the ChampSim GitHub profile \cite{champsim}.
...
\begin{itemize}
	\item My simulator is able to output the state of all tags at given points of execution.
	\item I can extract the state of the tag cache from ChampSim at given points of execution.
	\item The visualisation tool can read in both types of captured state and produce an image that accurately depicts it all.
\end{itemize}
