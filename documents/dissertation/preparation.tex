...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{tmc}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{itf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{tca}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{etm}
...
\begin{figure}[h]
	...
	\caption{The algorithm for reading tags. Memory access operations are highlighted blue. Operations internal to the tag controller are grey.}
	\label{fig:etr}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{The algorithm for writing tags.}
	\label{fig:etw}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{ett}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{mor}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{bbx}
...
\begin{itemize}
	...
	\item My project uses ChampSim, the open-source cache simulator. I also extend this program by adding logging support, by branching from commit \#2b8d3fc28abb6072d7675228418fa7cfe862d4dc. I took no part in contributing to any versions of ChampSim prior to the commit.
\end{itemize}
